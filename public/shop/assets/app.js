...
window.renderHeader=renderHeader;window.renderBottomNav=renderBottomNav;window.showToast=showToast;window.formatMoney=formatMoney;window.qs=qs;window.qsi=qsi;window.requireMerchantId=requireMerchantId;window.requireAuth=requireAuth;
